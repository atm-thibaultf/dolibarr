...
/**
 *   	\file       mo_products_list.php
 *		\ingroup    mrp
 *		\brief      List page for mo product to consume
 */
...
$object = new MoLine($db);
$extrafields = new ExtraFields($db);
$diroutputmassaction = $conf->mrp->dir_output.'/temp/massgeneration/'.$user->id;
$hookmanager->initHooks(array('moproductslist')); // Note that conf->hooks_modules contains array
...
$help_url = '';
$title = $langs->trans('ListOfNeededProductsForManufacturingOrders');
$morejs = array();
$morecss = array();
